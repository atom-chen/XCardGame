...
--
--------------------------------------------------------------------------------
local Logger = require("bdlib/tools/Logger")
...
--------------------------------------------------------------------------------
-- copy metatable when deepCopy
-- pls use "string.deepCopy" as far as possible
-- @param object copy
-- @return dest
-- @see deepCopy
--------------------------------------------------------------------------------
function M.deepCopyMeta(object)
    local lookup_table = {}
...
--[[ mfCopyTable is deprecated, use table.deepCopy or table.deepCopyMeta instead
function mfCopyTable(object)
    local lookup_table = {}
    local function _copy(object)
        if type(object) ~= "table" then
            return object
